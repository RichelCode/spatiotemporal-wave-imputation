...
at very short range---at 1~hour its WVHT error is only @pers1_wvht@~m and it is
...
adds real skill: about @gwn12_w@ (WVHT, $h{=}12$) rising to @gwn24_w@ at
$h{=}24$, and comparable skill on APD (@gwn12_a@ to @gwn24_a@). This is roughly
double the autoregressive model, whose WVHT skill is @ar12_w@ at $h{=}12$ and
@ar24_w@ at $h{=}24$. Figure~\ref{fig:horizon} shows how persistence degrades and
...
energy-forecast skill is @en_gwn12@ at $h{=}12$ and @en_gwn24@ at $h{=}24$---
larger than its own height and period skill---while the autoregressive model
reaches @en_ar12@ and @en_ar24@. The reason is the $H^{2}$ nonlinearity in
