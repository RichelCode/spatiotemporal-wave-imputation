...
@pers1_wvht@~m, and the best learned model improves on it by only @gwn1_w@, so we
report honestly that a learned model adds little at 1~hour. Second, that value
grows monotonically with horizon. Graph WaveNet's WVHT skill climbs from @gwn1_w@
at 1~hour to @gwn6_w@ at 6~hours and @gwn24_w@ at 24~hours, with a similar climb on
APD (@gwn1_a@ to @gwn24_a@). At 12--24~hours this is roughly double the
autoregressive model, whose WVHT skill is @ar12_w@ at $h{=}12$ and @ar24_w@ at
...
@en_gwn12@ at $h{=}12$ and @en_gwn24@ at $h{=}24$, larger than its own height and
period skill, while the autoregressive model reaches @en_ar12@ and @en_ar24@ at
